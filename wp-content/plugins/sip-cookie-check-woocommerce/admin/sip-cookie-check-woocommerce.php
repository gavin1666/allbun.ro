...
class SIP_Cookie_Check_WC_Admin {
	...
	// Build the custom admin page for managing addons, themes and licenses.
		...
		add_action( 'admin_enqueue_scripts', array( &$this, 'sip_ccwc_admin_enqueue') );
	}
	 ...
	 * @since 1.0.0
	 */
	public function sip_ccwc_admin_enqueue( ) {

		wp_enqueue_script( 'sip_ccwc_admin_script', plugin_dir_url( __FILE__ ) . 'assets/js/admin.js' , array('jquery'), '1.0.0', true );
	}
