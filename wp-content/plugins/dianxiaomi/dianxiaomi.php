            ...
            public function add_api_key_field($user)
            {
                ...
                if (current_user_can('edit_user', $user->ID)) {
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <th><label
                                    for="dianxiaomi_wp_api_key"><?php _e('Dianxiaomi\'s WordPress API Key', 'dianxiaomi'); ?></label>
                            </th>
                            <td>
                                <?php if (empty($user->dianxiaomi_wp_api_key)) : ?>
                                    <input name="dianxiaomi_wp_generate_api_key" type="checkbox"
                                           id="dianxiaomi_wp_generate_api_key" value="0"/>
